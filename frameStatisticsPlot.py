...
array_05 = np.load('./misc/frame_contribution_05.npy')
array_2 = np.load('./misc/frame_contribution_2.npy')
array_4 = np.load('./misc/frame_contribution_4.npy')
array_8 = np.load('./misc/frame_contribution_8.npy')
array_12 = np.load('./misc/frame_contribution_12.npy')
...
plt.savefig("./figures/amount_of_frames.png")
...
for arr in arr_list:
    ...
    plt.savefig("./figures/size_distribution_" + durations[i] + ".png")
    i+=1
