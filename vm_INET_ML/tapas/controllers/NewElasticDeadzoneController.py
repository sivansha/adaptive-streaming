...
class NewElasticDeadzoneController(BaseController):
    ...
    def __repr__(self):
        return '<NewElasticDeadzoneController-%d>' %id(self)
    ...
    def __getQueueLowWM(self):
        return self.queue_target - 2*self.feedback['fragment_duration']
