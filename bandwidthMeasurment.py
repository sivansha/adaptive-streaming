...
def plot_q4_d_and_e(results,debug):
    ...
    for i in range(4):
        ...
        ax.set(title='buffered time over time',
            ...
            xlabel='time [s]')
        ax.legend(legend)
    plt.savefig('./images/buf_time_over_time.png',dpi = 1200)
    plt.show()
    ...
    for i in range(4):
        ...
        ax.set(title='quality level over time',
            ...
            xlabel='time [s]')
        ax.legend(legend)
    plt.savefig('./images/quality_level_over_time.png',dpi = 1200)
    plt.show()
...
def plot_q4_f(results, debug):
    ...
    plt.savefig("./figures/average_quality_and_buffer_level.png")
    plt.show()
