...
def plot_QoE(results, debug):
    ...
    legend=["Delay = 0ms", "Delay = 25ms", "Delay = 50ms", "Delay = 100ms", "Delay = 200ms"]
    ...
    plt.title('Quality of experience values for the different delays with network setup 1Mb/s')
...
def main():
    ...
    Usage: python3 evaluateDelay.py [-d] path/to/log_dir
